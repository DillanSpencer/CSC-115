...
import com.quad.binarytree.BinarySearchTree;
...
public class MainApp {
	...
	public static void main(String...strings) {
		...
		BinaryTreeUtils.generateSimpleTree(tree);
		...
		tree.printTree(BinaryTree.INORDER);
		System.out.println("Value of key f: "+bst.findValue("f"));
